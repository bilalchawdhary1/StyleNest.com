  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        <div>
          <p className="mb-2">Product cetegory</p>
          <select
      ...
      <button type="submit" className="w-28 py-3 mt-4 text-white bg-black">
        ADD
      </button>
    </form>
  );
...
Add.propTypes = {
  token: PropTypes.string.isRequired, // Declare 'token' as required string
};
export default Add;
